...
const objSheriffdictionary = {
	...
	acting 			: 'керуючи',
	acted 			: 'керував',
	car 			: 'транспортним засобом «Ferrari 248 F1» д.н.з. АХ 1234 АВ',
...
{ 
	id 		: 'smoking', img: 'smoking', edit: { d: '19', m: '11', y: '2023', }, 
	fabula 	: '01.10.2015 о 15:20 год. гр. Іванов Іван Іванович курив електронну сигарету на території СЗОШ №15, що по вул. Проскурівського Підпілля, 125/1 в м. Хмельницькому, де відповідно до п. 3 Стаття 13 ЗУ «Про заходи щодо попередження та зменшення вживання тютюнових виробів та їх шкідливого впливу на здоров’я населення» куріння заборонено.',
	descr 	: 'КУРІННЯ',
	kupap 	: { art: '175_1', part: '1', },
	hash 	: { pdr_postanova: 1, kupap_a175_1_p1: 1, },
},
