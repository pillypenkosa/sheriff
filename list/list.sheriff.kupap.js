...
// --- 289 ------------------------------------------------------------------------------------------------------------------------------
	...
	{ 
		id 			: 'kupap_a289', a: 289, organ: 'a', edit: '22.11.2023',
		title 		: 'Скаргу на постанову по справі про адміністративне правопорушення може бути подано протягом десяти днів з дня винесення постанови, а щодо постанов по справі про адміністративні правопорушення у сфері забезпечення безпеки дорожнього руху, зафіксовані в автоматичному режимі, безпеки на автомобільному транспорті, зафіксовані за допомогою засобів фото- і кінозйомки, відеозапису, у тому числі в автоматичному режимі, постанов у справі про адміністративні правопорушення, передбачені статтею 132-2 цього Кодексу, та/або про порушення правил зупинки, стоянки, паркування транспортних засобів, зафіксовані в режимі фотозйомки (відеозапису), - протягом десяти днів з дня набрання постановою законної сили. В разі пропуску зазначеного строку з поважних причин цей строк за заявою особи, щодо якої винесено постанову, може бути поновлено органом (посадовою особою), правомочним розглядати скаргу.', 
		href 		: 'https://zakon.rada.gov.ua/laws/show/80731-10#n781', 
	},
...
// --- 307 ------------------------------------------------------------------------------------------------------------------------------
	...
	{ 
		id 			: 'kupap_a307_p1', a: 307, p: 1, organ: 'a', edit: '22.11.2023',
		title 		: 'Штраф має бути сплачений порушником не пізніш як через п’ятнадцять днів з дня вручення йому постанови про накладення штрафу, крім випадків, передбачених статтями 300-1, 300-2 цього Кодексу, а в разі оскарження такої постанови - не пізніш як через п’ятнадцять днів з дня повідомлення про залишення скарги без задоволення.', 
		href 		: 'https://zakon.rada.gov.ua/laws/show/80731-10#n952', 
	},
...
// --- 308 ------------------------------------------------------------------------------------------------------------------------------
	...
	{ 
		id 			: 'kupap_a308_p2', a: 308, p: 2, organ: 'a', edit: '22.11.2023',
		title 		: 'У порядку примусового виконання постанови про стягнення штрафу за вчинення адміністративного правопорушення з правопорушника стягується:', 
		sanction 	: 'подвійний розмір штрафу, визначеного у відповідній статті цього Кодексу та зазначеного у постанові про стягнення штрафу;',
		href 		: 'https://zakon.rada.gov.ua/laws/show/80731-10#n958', 
	},
